...
class Index extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        {this.state.introPageChose ? (
          <IntroPage onPageChange={this.renderNewPageState} />
        ) : (
          <></>
        )}
        {this.state.exportPageChosen ? (
          <ExportPage onPageChange={this.renderNewPageState} />
        ) : (
          <></>
        )}
        {this.state.exportMainPageChosen ? (
          <ExportMainPage onPageChange={this.renderNewPageState} />
        ) : (
          <></>
        )}
        {this.state.importMainPageChosen ? (
          <ImportMainPage onPageChange={this.renderNewPageState} />
        ) : (
          <></>
        )}
        {this.state.importPageChosen ? (
          <ImportPage onPageChange={this.renderNewPageState} />
        ) : (
          <></>
        )}
      </div>
