...
import { Page, Layout, EmptyState, Card, Button, OptionList } from "@shopify/polaris";
      ...
      >
        ...
        <Layout>
            ...
            <Layout.Section>
              ...
              {emptyState ? <></> : <ExportButton filters={this.state.selected}/>}
              {emptyState ? <></> : <div style={{ float: "right", marginTop: "10px", marginRight: "10px" }}><Button onClick={ () => this.setState({ open: true })}>Reselect Products</Button></div>}
